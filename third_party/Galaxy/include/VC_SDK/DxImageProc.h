...
#   define FLAT_FIELD_CORRECTION_DECLARE_HANDLE(name) \
    struct name##_; typedef struct name##_ *name
...
typedef enum  tagDX_STATUS
{
	...
	DX_FILE_VERSION_NOSUPPORT     = -201,
	DX_FILE_CONTENT_NOT_CALIB	  = -202,
	DX_FILE_CONTENT_NOT_ENOUGH	  = -203,
...
typedef struct FLAT_FIELD_CORRECTION_PARAMETER
{
    void                         *pBrightBuf;                  ///< Bright image buffer
    void                         *pDarkBuf;                    ///< dark image buffer
    GX_PIXEL_FORMAT_ENTRY        emPixelFormat;                ///< pixel format
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxSharpenMono8(void* pInputBuffer, void* pOutputBuffer, VxUint32 nWidth, VxUint32 nHeight, float fFactor);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxImageFormatConvertSet3DCalibParam(DX_IMAGE_FORMAT_CONVERT_HANDLE handle, const void* pCalibParamBuffer, const int nBufferSize);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxImageFormatConvertSetYStep(DX_IMAGE_FORMAT_CONVERT_HANDLE handle, const double dY);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxImageFormatConvertSetValidBits(DX_IMAGE_FORMAT_CONVERT_HANDLE handle, DX_VALID_BIT emValidBits);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxFFCCreate(DX_FLAT_FIELD_CORRECTION_HANDLE *phandle);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxFFCDestroy(DX_FLAT_FIELD_CORRECTION_HANDLE handle);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxFFCCalculate(DX_FLAT_FIELD_CORRECTION_HANDLE handle, const FLAT_FIELD_CORRECTION_PARAMETER *pstFFCParam, void *pFFCCoefficients, VxInt32 *pnFFCCoefficientsSize);
...
\param  pstFFCParam                  [in] flat field correction parameter
                                     Setting nFFCBlockSize to -1 enables the software-side algorithm,
                                     while any other value obtained from the camera activates the camera-side algorithm.
\param  pnFFCCoefficientsSize        [out]flat field correction coefficients size

\return emStatus
*/
//--------------------------------------------------
VxInt32 DHDECL DxFFCGetCoefficientsSize(DX_FLAT_FIELD_CORRECTION_HANDLE handle, const FLAT_FIELD_CORRECTION_PARAMETER *pstFFCParam, VxInt32 *pnFFCCoefficientsSize);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxFFCSetFrameCount(DX_FLAT_FIELD_CORRECTION_HANDLE handle, VxUint16 nFFCFrameCount);
