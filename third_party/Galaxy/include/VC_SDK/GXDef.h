...
typedef void* GX_CHUNK_DATA_HANDLE;                     ///< \Chinese 帧信息句柄	                                                                                 \English Chunk Data Handle

typedef uint64_t void_64;
enum GX_AUTO_CONNECTION_STATUS_ENTRY;
...
typedef struct GX_FRAME_BUFFER
{
	...
	void*       	pUserParam;						     ///< \Chinese 用户参数											\English User Param
    void_64         pChunkDataHandle;                    ///< \Chinese 帧信息句柄                               \chunk data handle
    int32_t         reserved[21];                        ///< \Chinese 保留												\English reserved
}GX_FRAME_BUFFER;
...
*/
//----------------------------------------------------------------------------------
typedef void (GX_STDC *GXDeviceDisconnectCallBack) (void *pUserParam);
...
*/
//----------------------------------------------------------------------------------
typedef void (GX_STDC *GXDeviceReconnectCallBack) (void *pUserParam);
