...
typedef enum GX_PIXEL_FORMAT_ENTRY
{
	...
	GX_PIXEL_FORMAT_COORD3D_ABC32F           = (GX_PIXEL_COLOR | GX_PIXEL_96BIT | 0X00C0),//0x021800C0, \Chinese 3D 坐标 A-B-C 32位点  \English 3D coordinate A-B-C 32-bit floating point 
	GX_PIXEL_FORMAT_COORD3D_ABC32F_PLANAR    = (GX_PIXEL_COLOR | GX_PIXEL_96BIT | 0X00C1),//0x021800C1, \Chinese 3D 坐标 A-B-C 32位面  \English 3D coordinate A-B-C 32-bit floating point planar
	GX_PIXEL_FORMAT_COORD3D_C16              = (GX_PIXEL_MONO  | GX_PIXEL_16BIT | 0x00B8),//0x011000B8, \Chinese 3D 坐标 C 16位        \English 3D coordinate C 16-bit
	GX_PIXEL_FORMAT_COORD3D_C16_I16          = (GX_PIXEL_MONO  | GX_PIXEL_16BIT | 0xFF02),//0x0110FF02, \Chinese 厂商自定义格式        \English Vendor-defined format
	GX_PIXEL_FORMAT_COORD3D_C16_S16          = (GX_PIXEL_MONO  | GX_PIXEL_16BIT | 0xFF03),//0x0110FF03, \Chinese 厂商自定义格式        \English Vendor-defined format
	GX_PIXEL_FORMAT_COORD3D_C16_I16_S16      = (GX_PIXEL_MONO  | GX_PIXEL_16BIT | 0xFF04),//0x0110FF04, \Chinese 厂商自定义格式        \English Vendor-defined format
