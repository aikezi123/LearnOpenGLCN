...
\brief		Portable GX_ENUM_ITEM_VALUE vector implementation
\Date       2016-8-09
...
{
	/**
	\brief     A vector of GX_ENUM_ITEM_VALUE object
	*/
	class GXIAPICPP_API TList_enum_item_vector
	{
		typedef GX_ENUM_ITEM_VALUE T;
		// Nested types
		// ---------------------------------------------------------------------------
	public:
		...
		// ---------------------------------------------------------------------------
	public:
		TList_enum_item_vector   ( void );
		explicit                  TList_enum_item_vector   ( size_t uiSize);
		TList_enum_item_vector   ( const TList_enum_item_vector &obj);
		virtual                   ~TList_enum_item_vector  ( void );
	...
	public:
		...
		// ---------------------------------------------------------------------------
	public:
		TList_enum_item_vector &         operator =        ( const TList_enum_item_vector &obj );
	...
	typedef TList_enum_item_vector gxenumitem_vector;
}
