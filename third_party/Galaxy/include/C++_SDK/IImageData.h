...
public:
	...
	*/
	...
	//----------------------------------------------------------------------------------
	/**
	\brief     To get the chunk data feature control
	\return    chunk data feature control
	*/
	//----------------------------------------------------------------------------------
	virtual IGXFeatureControl* GetChunkDataFeatureControl() = 0;
};
